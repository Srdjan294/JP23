...
public class E02UvjetnoGrananjeIf {
	...
	public static void main(String[] args) {
		...
		//osnovni if
		if(i==7) { // uvijek u if koristiti vitièaste zagrade
			System.out.println("To je OK");
		}
		
		if(i==7)
			System.out.println("To je isto OK");
		//kada if nema {} onda se odnosi samo na prvu sljedeæu liniju
		...
		//izraz iznad se ipak piše na ovaj naèin
		if(i==7 & j==10) {
			System.out.println("2OK 1");
		}
		
		// operator & æe provjeravati oba uvjeta
		// operater && koji ne provjerava drugi uvjet ako prvi nije zadovoljen
		
		// uobièajenija sintaksa
		if(i==7 && j==10) {
		...
		// || u sluèaju zadovoljenja 1. uvjeta drugi se ne provjerava
